...
import { str1 } from "../Components/index.js";
...
function StartShipment ({ startModel, setStartModel, startShipment }) {
  ...
  if(startModel) {
    (
      <div className="fixed inset-0 w-full h-full bg-black opacity-40">    <div className="flex items-center min-h-screen px-4 py-8">
