  ...
  return createShipmentModel ? (
    <div className="fixed inset-0 z-10 overflow-y-atuo">
      ...
      <div className=" flex items-center min-h-screen px-4 py-8">
        <div className="relative w-full max-w-lg p-4 mx-auto bg-white 
        rounded-md shadow-lg">
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            <h4 className=" text-lg font-medium text-gray-800">
              Get updated about all your shipment and products
            </h4>
           ...
           outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
              ...
              <button onClick={() => createItem()}
                className=" block w-full mt-3 py-3 px-4 font-medium
                 text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 activive:bg-indigo-700
